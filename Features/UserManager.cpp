        ...
        while (!line.empty()) {
            ...
            switch (i) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    user.userType = (UserType) (word == "OPD" ? UserType::OPD : word == "DOCTOR" ? UserType::DOCTOR : word == "IPD" ? UserType::IPD : word == "NURSE" ? UserType::NURSE : UserType::ADMIN);
                    break;
                case 7:
                    user.username = word;
                    break;
...
void UserManager::removeUser(User &user) {
  userMap.remove(UserManager::getHashNumber(user));
}
...
void UserManager::loadHistoryFromFile() {
    ...
    // Person who have to do anything with this function please implement this function (I think It's Wit's responsibility.)
